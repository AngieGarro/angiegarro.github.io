...
<div class="container">
  <div class="card card-danger" style="width: 70rem;">
  <div class="card-header"><strong>
    Contacto
    </strong>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item">Nos Ubicamos en Rincón de Arias, Grecia, Costa Rica</li>
    <li class="list-group-item">Contactenos al <strong>2444-5551</strong></li>
    <li class="list-group-item"><strong>Correo Eléctronico:</strong> motorepuestosrggrecia@gmail.com</li>
  </ul>
</div>
</br>
<div class="card card-secondary" style="width: 70rem;">
  <div class="card-header"><strong>
    Horario de Atención
    </strong>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item">Lunes - Sabado: <strong>8:00 AM - 5:00 PM</strong></li>
    <li class="list-group-item text-danger">Domingo: <strong>Cerrado</strong></li>
  </ul>
</div>
</div>
<!-- jQuery -->
